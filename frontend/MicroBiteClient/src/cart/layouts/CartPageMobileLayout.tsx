...
export default function CartPageMobileLayout() {
    ...
    <div className="p-3 max-w-200 mx-auto">
      ...
      {state.cartItems.length === 0 ? (
        ...
        <div className="flex flex-col gap-10">
          <div className="border-1 border-blue-500 rounded-2xl p-2">
            {state.cartItems.map((item) => (
              <div key={item.id} className="flex justify-between items-center p-4">
                <div className="flex-2">
                  ...
                  <p className="mt-1">Unit: {item.price} RON</p>
                </div>
            ...
            <div className="flex justify-between items-center mt-4 pt-4 pl-4 border-t-1 border-blue-500">
